...
public class BtsNeighborPECCHITtem implements Serializable{
	...
	private PECCHConfig mPECCHConfig; //2
	...
	public PECCHConfig getmPECCHConfig() {
		return mPECCHConfig;
	}

	public void setmPECCHConfig(PECCHConfig mPECCHConfig) {
		this.mPECCHConfig = mPECCHConfig;
	}
