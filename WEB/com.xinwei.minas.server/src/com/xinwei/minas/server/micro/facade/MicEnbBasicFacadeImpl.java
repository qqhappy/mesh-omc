...
public class MicEnbBasicFacadeImpl extends UnicastRemoteObject implements
		MicEnbBasicFacade {

	protected MicEnbBasicFacadeImpl() throws RemoteException {
		super();
	}
	...
	private MicEnbBasicService getService() {
		return AppContext.getCtx().getBean(MicEnbBasicService.class);
	}
