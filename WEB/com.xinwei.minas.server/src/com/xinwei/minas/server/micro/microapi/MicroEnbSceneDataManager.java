...
public class MicroEnbSceneDataManager {
	
	private EnbSceneDataShow enbSceneDataShow = new EnbSceneDataShow();
	
	private static MicroEnbSceneDataManager instance = new MicroEnbSceneDataManager();
	
	private String tagConfigFileZh = "plugins/micro/provision/EnbToOamDispXmlCH.xml";
	
	private String tagConfigFileEn = "plugins/micro/provision/EnbToOamDispXmlEN.xml";
	
	public static MicroEnbSceneDataManager getInstance() {
		return instance;
	}
