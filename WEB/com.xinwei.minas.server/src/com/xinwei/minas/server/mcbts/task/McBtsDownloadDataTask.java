...
public class McBtsDownloadDataTask implements Runnable {

	private Long btsId;

	private static final Log log = LogFactory
			.getLog(McBtsDownloadDataTask.class);

	private McBtsSynConfigService syncConfigService;

	private McBtsDownloadDataTaskManager manager;

	public McBtsDownloadDataTask(Long btsId,
			McBtsDownloadDataTaskManager manager) {
		this.btsId = btsId;
