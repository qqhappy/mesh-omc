...
public class EnbBasicServiceImpl implements EnbBasicService {

	private Log log = LogFactory.getLog(EnbBasicServiceImpl.class);
					...
					public Exception doInTransaction(TransactionStatus txStatus) {
						try {
							Method method = ReflectUtils.findMethod(
									EnbBasicServiceImpl.class, methodName);
							method.invoke(EnbBasicServiceImpl.this, args);
						} catch (Exception e) {
