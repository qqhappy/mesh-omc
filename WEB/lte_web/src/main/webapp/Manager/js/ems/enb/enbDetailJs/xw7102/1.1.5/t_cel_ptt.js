$(function(){
			...
			$.ajax({ 
				...
				success:function(data){		
					...
					if(errorHtml != null && errorHtml != ""){					
						...
						window.location.href=""+basePath+"/lte/queryEnbBiz.do?enbVersion="+enbVersion+"&moId="+moId+"&operType=select"+"&browseTime="+getBrowseTime()+"&tableName=T_CEL_PTT-1.1.5";
					}				
				}
			});	
		}
	...
	$("#t_cel_ptt1 tr").each(function(index){
		...
		//
		if($("#t_cel_ptt1 tr:eq("+index+") td:eq(10)").text() == 0){
			$("#t_cel_ptt1 tr:eq("+index+") td:eq(10)").text("关");
		}else{
			$("#t_cel_ptt1 tr:eq("+index+") td:eq(10)").text("开");	
		}
		//
		if($("#t_cel_ptt1 tr:eq("+index+") td:eq(11)").text() == 0){
			$("#t_cel_ptt1 tr:eq("+index+") td:eq(11)").text("10");
		}else if($("#t_cel_ptt1 tr:eq("+index+") td:eq(11)").text() == 1){
			$("#t_cel_ptt1 tr:eq("+index+") td:eq(11)").text("20");
		}else if($("#t_cel_ptt1 tr:eq("+index+") td:eq(11)").text() == 2){
			$("#t_cel_ptt1 tr:eq("+index+") td:eq(11)").text("30");
		}else if($("#t_cel_ptt1 tr:eq("+index+") td:eq(11)").text() == 3){
			$("#t_cel_ptt1 tr:eq("+index+") td:eq(11)").text("40");
		}else if($("#t_cel_ptt1 tr:eq("+index+") td:eq(11)").text() == 4){
			$("#t_cel_ptt1 tr:eq("+index+") td:eq(11)").text("60");
		}else if($("#t_cel_ptt1 tr:eq("+index+") td:eq(11)").text() == 5){
			$("#t_cel_ptt1 tr:eq("+index+") td:eq(11)").text("80");
		}else if($("#t_cel_ptt1 tr:eq("+index+") td:eq(11)").text() == 6){
			$("#t_cel_ptt1 tr:eq("+index+") td:eq(11)").text("120");
		}else if($("#t_cel_ptt1 tr:eq("+index+") td:eq(11)").text() == 7){
			$("#t_cel_ptt1 tr:eq("+index+") td:eq(11)").text("160");
		}else if($("#t_cel_ptt1 tr:eq("+index+") td:eq(11)").text() == 8){
			$("#t_cel_ptt1 tr:eq("+index+") td:eq(11)").text("320");
		}else{
			$("#t_cel_ptt1 tr:eq("+index+") td:eq(11)").text("640");	
		}
		//
		var u8PttSpsThrRbNum = $("#t_cel_ptt1 tr:eq("+index+") td:eq(12)").text();
		var u8PttSpsThrRbNumLit = accDiv(u8PttSpsThrRbNum,100);
		$("#t_cel_ptt1 tr:eq("+index+") td:eq(12)").text(u8PttSpsThrRbNumLit);
		//
		if($("#t_cel_ptt1 tr:eq("+index+") td:eq(13)").text() == 0){
			$("#t_cel_ptt1 tr:eq("+index+") td:eq(13)").text("关");
		}else{
			$("#t_cel_ptt1 tr:eq("+index+") td:eq(13)").text("开");	
		}
	...
	//跳转到配置
	$("#t_cel_ptt1 tr").each(function(index){
		$("#t_cel_ptt1 tr:eq("+index+") td:eq(18)").click(function(){
			var u8CId = $("#t_cel_ptt1 tr:eq("+index+") td:eq(0)").text();
			var para = "u8CId"+"="+u8CId;
			var basePath = $("#basePath").val();
			var moId = $("#moId").val();
			var enbVersion = $("#enbVersion").val();
			window.location.href=""+basePath+"/lte/turnConfigEnbBiz.do?moId="+moId+"&enbVersion="+enbVersion+""+"&browseTime="+getBrowseTime()+"&tableName=T_CEL_PTT-1.1.5&parameters="+para+"";
		});					   
	});	
	//跳转到配置
	$("#t_cel_ptt1 tr").each(function(index){
	...
	$("#t_cel_ptt1 tr").each(function(index){
		$("#t_cel_ptt1 tr:eq("+index+") td:eq(19)").click(function(){
			...
			if(confirm("确定要删除该条记录?")){
				var enbVersion = $("#enbVersion").val();
				window.location.href=""+basePath+"/lte/queryEnbBiz.do?enbVersion="+enbVersion+"&operType=delete&moId="+moId+""+"&browseTime="+getBrowseTime()+"&tableName=T_CEL_PTT-1.1.5&parameters="+para+"";
			}
		});					   
	});	
	//批量删除
	$("#delete").click(function(){
		...
		if(str.length < 1){
			...
			if(confirm("确定要删除所有选择的记录?")){
				var enbVersion = $("#enbVersion").val();
				window.location.href=""+basePath+"/lte/queryEnbBiz.do?enbVersion="+enbVersion+"&operType=multiDelete&moId="+moId+""+"&browseTime="+getBrowseTime()+"&tableName=T_CEL_PTT-1.1.5&parameters="+para+"";
			}
		}	
	});
	//取消按钮
