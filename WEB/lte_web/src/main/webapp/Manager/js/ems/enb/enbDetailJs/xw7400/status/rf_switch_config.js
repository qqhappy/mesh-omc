$(function(){
	...
	$("#boardFlag").change(function(){
		...
		var href = basePath+"/lte/configStatus.do?statusFlag="+statusFlag+"&moId="+moId+"&enbHexId="+enbHexId+"&boardFlag="+boardFlag;
	...
	function config() {
		...
		var href = basePath+"/lte/configStatus.do?operType=config&statusFlag="+statusFlag+"&moId="+moId+"&enbHexId="+enbHexId+"&boardFlag="+boardFlag;
		if(statusFlag == "RF_SWITCH") {
