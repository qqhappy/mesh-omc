function popWin(a){
	function n(){
		...
		i.mousedown(function(a){
			c=!0,d=a.pageX-parseInt(f.css("left")),
		...
		$('<div id="maskLayer"></div>').appendTo("body").css({background:"#000",opacity:".4",top:0,left:0,position:"absolute",zIndex:"8000"}),
		n(),
