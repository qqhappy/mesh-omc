$(function() {
	...
	$("#fresh").click(function(){
		...
		var href = basePath+"/lte/queryStatus.do?statusFlag=ENB_STATUS&moId="+moId+"&enbHexId="+enbHexId;
...
//	=6:异常(abnormal)
	...
	$("#changeEnbTime").click(function(){
		...
		if(isTimeEnable!="disabled") {
			...
			var enbVersion = $("#enbVersion").val();
			var href = basePath+"/lte/configStatus.do?operType=config&statusFlag=ENB_TIME&moId="+moId+"&enbHexId="+enbHexId+"&enbTime="+enbTime+"&enbVersion="+enbVersion;
