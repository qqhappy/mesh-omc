...
public class XJsonUtils {
	...
	/**
	 * 将对象转换为json对象 采用默认的格式处理对象(dateformat:yyyy-MM-dd hh:mm:ss)
	 * 
	 * @param obj
	 * @return
	 */
	...
	public static String object2JsonObjStr(Object obj) {
		...
		return com.alibaba.fastjson.JSON.toJSONStringWithDateFormat(obj,
				DATE_FORMAT);
	}
	...
	/**
	 * 通过属性名查找json串中对应的值 不支持对数组或集合的属性值进行查找
	 * 
	 * @param jsonStr
	 *            json字符串
	 * @param propertyName
	 ...
	 * @return
	 */
	public static Object getPropetyValueByName(String jsonStr,
			String propertyName) {
		com.alibaba.fastjson.JSONObject jsonObject = com.alibaba.fastjson.JSON
				.parseObject(jsonStr);
